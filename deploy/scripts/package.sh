...
echo "可以使用以下命令将包上传到服务器:"
echo "scp $APP_DIR/$PACKAGE_NAME user@your-server:/tmp/"
echo "然后在服务器上执行:"
echo "mkdir -p /opt/aikg"
echo "tar -xzf /tmp/$PACKAGE_NAME -C /opt/aikg"
echo "chown -R aikg:aikg /opt/aikg" 